const CACHE_NAME = 'rewear-v22';
const ASSETS = ['./', './index.html', './style.css', './platform.css', './platform.js', './wardrobe.html', './current.html', './market.html', './fabric.html', './profile.html', './config.js', './firebase-auth.js', './manifest.webmanifest', './icon.svg', './icon-maskable.svg'];
